...
{
  var HOSTED_VIEWER_ORIGINS_ENV = process.env.HOSTED_VIEWER_ORIGINS;
  if (HOSTED_VIEWER_ORIGINS_ENV === undefined) {
    HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io'];
  } else {
    HOSTED_VIEWER_ORIGINS = HOSTED_VIEWER_ORIGINS_ENV.split(',');
  }
